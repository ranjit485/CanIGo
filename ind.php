...
<body style="background: #fff">
    <section id="home" class="hero-section-wrapper-4">
        ...
        <div class="row position-fixed mb-4">
        <div class="col-lg-6">
        <div class="hero-content-wrapper position-static">
        <h2 class="mb-30 wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">Welcome To The Complaint Manangement System</h2>
        <p class="mb-30 wow fadeInUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">Take advantage of this service to register your complaint.</p>
