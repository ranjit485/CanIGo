...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
    ...
    $stmt_insert_complaint = $conn->prepare("INSERT INTO complaints (StudentID,HODID, ComplaintType, ByHOD,ByAdmin, Discription) VALUES (?,?,?,'Assigend','Assigend',?)");
    
    if (!$stmt_insert_complaint) {
        die("Error in preparing the statement: " . $conn->error);
    }

    $stmt_insert_complaint->bind_param("ssss", $student_id,$hod_id, $complaint_type,$discription);
