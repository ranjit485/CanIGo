        ...
        <div class="card" style="border-radius: 15px;">
          <div class="card-body text-center">
            ...
            <p class="text-muted mb-4">
                <?php echo"".$_SESSION["teacher_class"]." ".$_SESSION["teacher_department"].""; ?></p>
            <div class="card mb-4">
          <div class="card-body">
            <div class="row">
              <div class="col-sm-4">
              ...
              <div class="col-sm-8">
                <p class="text-muted mb-0"><?php echo"".$_SESSION["teacher_id"].""; ?></p>
              </div>
            </div>
            <hr>
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0"><?php echo"".$_SESSION["teacher_username"].""; ?></p>
              </div>
            </div>
            <hr>
            <div class="row">
              ...
              <div class="col-sm-8">
                <p class="text-muted mb-0"><?php echo"".$_SESSION["teacher_department"].""; ?></p>
              </div>
            </div>
          </div>
        </div>
