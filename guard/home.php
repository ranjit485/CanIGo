                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="http://127.0.0.1:5501/guard_dashbord.html#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu dropdown-menu-left shadow animated--grow-in" aria-labelledby="userDropdown">
                                    ...
                                    <a class="dropdown-item" href="http://127.0.0.1:5501/guard_dashbord.html#">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle mt-2" href="http://127.0.0.1:5501/guard_dashbord.html#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-left shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="http://127.0.0.1:5501/guard_dashbord.html#">
                                    <div class="mr-3">
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="http://127.0.0.1:5501/guard_dashbord.html#">Show All Alerts</a>
                            </div>
                        </li>

                        <!-- Nav Item - Messages -->
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle mt-2" href="http://127.0.0.1:5501/guard_dashbord.html#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-left shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="http://127.0.0.1:5501/guard_dashbord.html#">
                                    ...
                                    <a class="dropdown-item text-center small text-gray-500" href="http://127.0.0.1:5501/guard_dashbord.html#">Read More Messages</a>
                            </div>
                        </li>
